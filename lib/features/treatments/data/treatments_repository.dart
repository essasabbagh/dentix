...
class TreatmentsRepository {
  ...
  Stream<List<TreatmentModel>> watchPatientTreatments(int patientId) => _db
      .treatmentsDao
  ...
  Future<int> insertTreatment({
    ...
    String? notes,
  }) => _db.treatmentsDao.insertTreatment(
  ...
  Future<bool> updateTreatment(TreatmentModel t) =>
      _db.treatmentsDao.updateTreatment(
  ...
  Future<int> deleteTreatment(int id) => _db.treatmentsDao.deleteTreatment(id);
}
